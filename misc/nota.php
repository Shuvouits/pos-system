...
$pdf->Cell(60,10,'Shuvo Bhowmik',0,1,'C');

$pdf->Line(10,18,72,18);
$pdf->Line(10,19,72,19);

$pdf->SetFont('Arial','',8);
$pdf->Cell(60,3,'2 no luxmibazar Dhaka, Bangladesh',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,3,'Menjual Bahan Bangunan, Perlengkapan Listri, DLL',0,1,'C');

$pdf->SetFont('Arial','',8);
$pdf->Cell(63,4,'No. Telp: +8801751720590 (shuvo)',0,1,'C');
...
$pdf->Cell(20,4 ,'No. Bill     :',0,0,'C');

$pdf->SetFont('Courier','BI',8);
$pdf->Cell(10,4 ,$row->invoice_id,0,1,'C');

$pdf->SetFont('Courier','B',8);
$pdf->Cell(20,4 ,'Name.employee     :',0,0,'C');
//$pdf->Cell(20,4 ,'Name of employee :',0,0,'C');
