              ...
              <?php
                ...
                <div class="col-md-6">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item"><b>Regular Price</b>  :<span class="label label-warning pull-right">Rp. <?php echo number_format($row->purchase_price); ?></span></li>
                    <li class="list-group-item"><b>Selling Price</b>     :<span class="label label-warning pull-right">Rp. <?php echo $row->sell_price; ?></span></li>
                    <li class="list-group-item"><b>Discount</b>           :<span class="label label-success pull-right">Rp. <?php echo number_format(($row->sell_price - $row->purchase_price)); ?></span></li>
