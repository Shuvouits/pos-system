      ...
      <div class="col-md-offset-1 col-md-10">
        <div class="box box-success">
          <div class="box-header with-border">
              <h3 class="box-title">Products Sales History</h3>
          </div>
          <div class="box-body">
            <div class="col-md-offset-1 col-md-10">
                  ...
                  <table class="table table-striped" id="myBestProduct">
                      ...
                      <tbody>
                         ...
                         // tbl_invoice_detail GROUP BY product_id ORDER BY sum(qty) DESC LIMIT 30");
                          ...
                          $select = $pdo->prepare("SELECT product_name, product_code, order_date, time_order, due FROM tbl_invoice");
