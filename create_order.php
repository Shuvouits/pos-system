    ...
    if(isset($_POST['save_order'])){
     ...
     // $arr_product_name = $_POST['productname'];
      ...
      if($arr_product_code == ""){
        ...
        $insert = $pdo->prepare("INSERT INTO tbl_invoice(cashier_name, order_date, time_order, total, paid, due, product_name, product_code)
        values(:name, :orderdate, :timeorder, :total, :paid, :due, :productname, :productcode)");
        ...
        $insert->bindParam(':productname', $product_name);
        $insert->bindParam(':productcode', $product_code);
        ...
        if($invoice_id!=null){
          for($i=0; $i<count($arr_product_id); $i++){
            ...
            $insert = $pdo->prepare("INSERT INTO tbl_invoice_detail(invoice_id, product_id,  qty, product_satuan, price, total, order_date)
            values(:invid, :productid,  :qty, :productsatuan, :price, :total, :orderdate)");
